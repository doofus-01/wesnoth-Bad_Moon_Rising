        		...
        		return T.list_definition { T.row { T.column { horizontal_grow = true, 
				     ...
				     T.row { 
				     	     T.column { horizontal_alignment = "left", T.grid { 
				     			T.row { T.column { T.label { text_aligment = "left", id = "the_label"} }},
				     			T.row { T.column { T.label { text_aligment = "left", id = "the_HP"} }},
				     			T.row { T.column { T.label { text_aligment = "left", id = "the_XP"} }}
				     	    		}},
                                 	     T.column { T.image { id = "the_icon", linked_group = "icons" } },
                		 	     T.column { T.toggle_button { tooltip = "sets whether is 'on call' or not" , definition ='radio', id = "the_on_call_button", linked_group = "call_buttons"} }
					   }
					}}
				}}}
end                                                                                                                                                                
function info_grid()
			return T.grid {
				T.row { T.column { T.label { id = "the_headcount"}}},
				T.row { T.column { T.label { id = "the_upkeep"}}}
				}
end                                                                                                                                                                
function unit_grid()
			return T.grid {
				...
				T.row { T.column { horizontal_grow = true, T.label { wrap = "false", id = "the_unit_traits"}}},

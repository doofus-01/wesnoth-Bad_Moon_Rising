...
table.insert(bmr_units, {subtopic_id = _ "Enemies", subtopic_text = _ "<small>    Enemies can use most of the same weapons and armor as your forces, and also become stronger as the campaign progresses.\n  The scaling of the enemy strength is seen in the enemy traits. </small> \n ", subtopic_image = "help/ai_debug.webp~GS()", subtopic_icon = "help/enemy_panel.webp~GS()"})
...
bmr_e_g["heavy_armor"] = _ "for heavy infantry"
